...
def lose():
  ...
  time.sleep(2)
  print("I'm sorry, you lost", betmoney, "$...")
  print('\n')
  time.sleep(1)
...
def getamount(num1, multi):
  sentences_for_gametype = ["You chose to bet on a specific Number... You are a gambler!", "You chose to bet on red Numbers...", "You chose to bet on black Numbers...", "You chose to bet on odd Numbers...", "You chose to bet on even Numbers...", "You chose to bet on Numbers between 1 and 18...", "You chose to bet on Numbers between 19 and 36...", "You chose to bet on Numbers between 1 and 12...", "You chose to bet on Numbers between 13 and 24...", "You chose to bet on Numbers between 25 and 36...", "You chose to bet on the first column...", "You chose to bet on the second column...", "You chose to bet on the third column..."]
  print('\n')
  global betmoney
  global budget
  global betin
  print(sentences_for_gametype[num1 - 1])
  if num1 == 1:
    while True:
    ...
    while True:
      ...
      try:
        ...
        if budget >= betmoney:
          print("You can possibly win:", (betmoney * multi) - betmoney, "$!")
          print('\n' * 2)
          print(random.choice(randomsentences))
          time.sleep(1)
          break
...
while budget > 0:
  ...
  while True:
    ...
    try:
      ...
      if answerbet in range(1, 14):
        ...
        print("Error - Your Input is not on the table of possible bets.")
    break
  ...
  if answerbet == 13 and land % 3 != 0:
    lose()
print("You lost all your Money... We hope to see you soon again!")
